...
def _render_finetune_panel(cfg: dict) -> None:
    ...
    with (
        ...
        new_img_patches, new_mask_patches = _preprocess_finetune_data(
            cfg, tmp_img_path, tmp_mask_path, progress_bar, status_text
        )
        ...
        _run_finetuning(
            cfg, new_img_patches, new_mask_patches, progress_bar, status_text, metrics_holder
        )
